...
- **Outcome**: Both measurements answered — decision 3: no (see decisions table); decision 6: a
  ...
  size, and results table in `docs/internal/measurements.md`. Cross-user replay (C2) was not pursued —
...
discrimination length) are closed as of Phase 6 — see `docs/internal/measurements.md`.*
